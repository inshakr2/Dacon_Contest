...
# train (event T = 10)
train = data_loader_all(data_loader, path = train_path, train = True, nrows = 16, normal = 999, event_time = 10, lookup_table = label)

file = open('e:/Dacon/train_16R_10ET.txt','wb')      
